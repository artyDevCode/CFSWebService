...
namespace CFSWebService.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            //List<string> gender = new  List<string> { "FEMALE", "MALE", "OTHER"};
            //SelectList BUNames = new SelectList(gender);
            //ViewData["BUNames"] = BUNames;
            return View();
        }
        ...
        [AllowAnonymous]
        // [Route("Account/ConfirmEmail", Name = "ConfirmEmail")] 
        public async Task<ActionResult> ConfirmEmail(string userId, string code)
        {

            string aa =  Uri.EscapeDataString(code);
            ...
            try
            {
                result = await UserManager.ConfirmEmailAsync(userId, aa);
            }
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                string callbackUrl = await SendEmailConfirmationTokenAsync(user.Id, "Reset your account");
